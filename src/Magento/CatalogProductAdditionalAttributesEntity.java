...
public class CatalogProductAdditionalAttributesEntity  implements java.io.Serializable {
    private Magento.AssociativeMultiEntity[] multi_data;
    ...
    public CatalogProductAdditionalAttributesEntity(
           Magento.AssociativeMultiEntity[] multi_data,
     ...
     * @return multi_data
     */
    public Magento.AssociativeMultiEntity[] getMulti_data() {
        return multi_data;
    }
     ...
     * @param multi_data
     */
    public void setMulti_data(Magento.AssociativeMultiEntity[] multi_data) {
        this.multi_data = multi_data;
    }
