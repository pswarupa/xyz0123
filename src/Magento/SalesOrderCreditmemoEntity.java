...
public class SalesOrderCreditmemoEntity  implements java.io.Serializable {
    ...
    private Magento.SalesOrderCreditmemoItemEntity[] items;

    private Magento.SalesOrderCreditmemoCommentEntity[] comments;
    ...
    public SalesOrderCreditmemoEntity(
           ...
           Magento.SalesOrderCreditmemoItemEntity[] items,
           Magento.SalesOrderCreditmemoCommentEntity[] comments) {
     ...
     * @return items
     */
    public Magento.SalesOrderCreditmemoItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(Magento.SalesOrderCreditmemoItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public Magento.SalesOrderCreditmemoCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(Magento.SalesOrderCreditmemoCommentEntity[] comments) {
        this.comments = comments;
    }
