...
public class GiftMessageAssociativeProductsEntity  implements java.io.Serializable {
    private Magento.ShoppingCartProductEntity product;

    private Magento.GiftMessageEntity message;

    public GiftMessageAssociativeProductsEntity() {
    }

    public GiftMessageAssociativeProductsEntity(
           Magento.ShoppingCartProductEntity product,
           Magento.GiftMessageEntity message) {
     ...
     * @return product
     */
    public Magento.ShoppingCartProductEntity getProduct() {
        return product;
    }
     ...
     * @param product
     */
    public void setProduct(Magento.ShoppingCartProductEntity product) {
        this.product = product;
    }
     ...
     * @return message
     */
    public Magento.GiftMessageEntity getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(Magento.GiftMessageEntity message) {
        this.message = message;
    }
