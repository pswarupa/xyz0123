...
public class ShoppingCartInfoEntity  implements java.io.Serializable {
    ...
    private Magento.ShoppingCartAddressEntity shipping_address;

    private Magento.ShoppingCartAddressEntity billing_address;

    private Magento.ShoppingCartItemEntity[] items;

    private Magento.ShoppingCartPaymentEntity payment;
    ...
    public ShoppingCartInfoEntity(
           ...
           Magento.ShoppingCartAddressEntity shipping_address,
           Magento.ShoppingCartAddressEntity billing_address,
           Magento.ShoppingCartItemEntity[] items,
           Magento.ShoppingCartPaymentEntity payment) {
     ...
     */
    public Magento.ShoppingCartAddressEntity getShipping_address() {
        return shipping_address;
    }
     ...
     */
    public void setShipping_address(Magento.ShoppingCartAddressEntity shipping_address) {
        this.shipping_address = shipping_address;
    }
     ...
     */
    public Magento.ShoppingCartAddressEntity getBilling_address() {
        return billing_address;
    }
     ...
     */
    public void setBilling_address(Magento.ShoppingCartAddressEntity billing_address) {
        this.billing_address = billing_address;
    }
     ...
     * @return items
     */
    public Magento.ShoppingCartItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(Magento.ShoppingCartItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return payment
     */
    public Magento.ShoppingCartPaymentEntity getPayment() {
        return payment;
    }
     ...
     * @param payment
     */
    public void setPayment(Magento.ShoppingCartPaymentEntity payment) {
        this.payment = payment;
    }
