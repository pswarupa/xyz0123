...
public class CatalogProductAttributeEntity  implements java.io.Serializable {
    ...
    private Magento.AssociativeEntity[] additional_fields;

    private Magento.CatalogAttributeOptionEntity[] options;

    private Magento.CatalogProductAttributeFrontendLabelEntity[] frontend_label;
    ...
    public CatalogProductAttributeEntity(
           ...
           Magento.AssociativeEntity[] additional_fields,
           Magento.CatalogAttributeOptionEntity[] options,
           Magento.CatalogProductAttributeFrontendLabelEntity[] frontend_label) {
     ...
     */
    public Magento.AssociativeEntity[] getAdditional_fields() {
        return additional_fields;
    }
     ...
     */
    public void setAdditional_fields(Magento.AssociativeEntity[] additional_fields) {
        this.additional_fields = additional_fields;
    }
     ...
     * @return options
     */
    public Magento.CatalogAttributeOptionEntity[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(Magento.CatalogAttributeOptionEntity[] options) {
        this.options = options;
    }
     ...
     */
    public Magento.CatalogProductAttributeFrontendLabelEntity[] getFrontend_label() {
        return frontend_label;
    }
     ...
     */
    public void setFrontend_label(Magento.CatalogProductAttributeFrontendLabelEntity[] frontend_label) {
        this.frontend_label = frontend_label;
    }
