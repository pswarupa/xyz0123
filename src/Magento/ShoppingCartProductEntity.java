...
public class ShoppingCartProductEntity  implements java.io.Serializable {
    ...
    private Magento.AssociativeEntity[] options;

    private Magento.AssociativeEntity[] bundle_option;

    private Magento.AssociativeEntity[] bundle_option_qty;
    ...
    public ShoppingCartProductEntity(
           ...
           Magento.AssociativeEntity[] options,
           Magento.AssociativeEntity[] bundle_option,
           Magento.AssociativeEntity[] bundle_option_qty,
     ...
     * @return options
     */
    public Magento.AssociativeEntity[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(Magento.AssociativeEntity[] options) {
        this.options = options;
    }
     ...
     */
    public Magento.AssociativeEntity[] getBundle_option() {
        return bundle_option;
    }
     ...
     * @param bundle_option
     */
    public void setBundle_option(Magento.AssociativeEntity[] bundle_option) {
        this.bundle_option = bundle_option;
    }
     ...
     */
    public Magento.AssociativeEntity[] getBundle_option_qty() {
        return bundle_option_qty;
    }
     ...
     */
    public void setBundle_option_qty(Magento.AssociativeEntity[] bundle_option_qty) {
        this.bundle_option_qty = bundle_option_qty;
    }
