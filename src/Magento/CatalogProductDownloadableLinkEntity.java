...
public class CatalogProductDownloadableLinkEntity  implements java.io.Serializable {
    ...
    private Magento.CatalogProductDownloadableLinkFileInfoEntity[] file_save;

    private Magento.CatalogProductDownloadableLinkFileInfoEntity[] sample_file_save;
    ...
    public CatalogProductDownloadableLinkEntity(
           ...
           int sort_order,
           Magento.CatalogProductDownloadableLinkFileInfoEntity[] file_save,
           Magento.CatalogProductDownloadableLinkFileInfoEntity[] sample_file_save) {
     ...
     * @return file_save
     */
    public Magento.CatalogProductDownloadableLinkFileInfoEntity[] getFile_save() {
        return file_save;
    }
     ...
     * @param file_save
     */
    public void setFile_save(Magento.CatalogProductDownloadableLinkFileInfoEntity[] file_save) {
        this.file_save = file_save;
    }
     ...
     */
    public Magento.CatalogProductDownloadableLinkFileInfoEntity[] getSample_file_save() {
        return sample_file_save;
    }
     ...
     */
    public void setSample_file_save(Magento.CatalogProductDownloadableLinkFileInfoEntity[] sample_file_save) {
        this.sample_file_save = sample_file_save;
    }
