...
public class CatalogProductTagInfoEntity  implements java.io.Serializable {
    ...
    private Magento.AssociativeEntity[] products;
    ...
    public CatalogProductTagInfoEntity(
           ...
           Magento.AssociativeEntity[] products) {
           this.name = name;
           this.status = status;
     ...
     * @return products
     */
    public Magento.AssociativeEntity[] getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void setProducts(Magento.AssociativeEntity[] products) {
        this.products = products;
    }
